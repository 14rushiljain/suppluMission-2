...
box1=createSprite(360,490,20,100);
box1.shapeColor=color(255,0,0);

box2=createSprite(240,490,20,100);
box2.shapeColor=color(255,0,0);

box3=createSprite(300,530,100,20);
...
//Create a Ground
ground = Bodies.rectangle(width/2, 550, width, 10 , ground_options);
